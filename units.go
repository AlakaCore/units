...
// File autogenerated on 2022-02-10 17:14:50.676407533 -0600 CST m=+0.000642223.
...
// Base always returns _NumberNumberUnit
func (x Number) Base() Unit {
	return _NumberNumberUnit
}

// NumberUnits is effectively a constant
var NumberUnits = [...]Unit{_NumberNumberUnit}
...
// Unit.FromBase: n => n =
// Unit.ToBase  : n => n =
type _NumberNumber Number

// Title always returns "Number"
func (x _NumberNumber) Title() string {
	return "Number"
}
...
// _NumberNumberMatchList is effectively a constant
var _NumberNumberMatchList = [...]string{"number", "*"}

// MatchList always returns _NumberNumberMatchList[:]
func (x _NumberNumber) MatchList() []string {
	return _NumberNumberMatchList[:]
}
...
var _NumberNumberUnit _NumberNumber = 0.0
